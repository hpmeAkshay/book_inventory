...
ActiveRecord::Schema[7.1].define(version: 2024_02_29_134107) do
  ...
  create_table "book_summaries", force: :cascade do |t|
    t.integer "book_id"
    t.integer "total_quantity_sold", default: 0
    t.decimal "total_revenue", precision: 10, scale: 2, default: "0.0"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id"], name: "index_book_summaries_on_book_id"
  end
  ...
  add_foreign_key "book_summaries", "books"
